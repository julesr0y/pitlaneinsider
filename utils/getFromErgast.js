...
/**
    * @function
    * @description Fonction permettant de récupérer des données depuis l'API Ergast
    * @param {string} endpoint - Fin de l'adresse de la requête à l'API
    * @returns {Promise} - Promesse contenant la réponse de l'API
    */
async function getFromErgast(endpoint) {
    var url = 'https://ergast.com/api/f1/' + endpoint; // On définit l'URL de l'API, avec l'endpoint en paramètre
